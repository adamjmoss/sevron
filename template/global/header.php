        ...
        <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " >
            <div class="kt-header-mobile__logo">
                <a href="/sevron/">
                <img alt="Logo" src="./sevron/assets/media/logos/logo-11-sm.png"/>
                </a>
            </div>
            ...
            <div class="kt-container  kt-container--fluid ">
                ...
                <div class="kt-header__brand " id="kt_header_brand">
                    <div class="kt-header__brand-logo">
                        <a href="/sevron/">
                            <img alt="Logo" src="./sevron/assets/media/logos/sevron-logo.svg" height="50"/>
                        </a>		
                    </div>
                </div>
                <!-- end:: Brand -->		
                ...
                <div class="kt-header__topbar">
                    ...
                    <div class="kt-header__topbar-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                            <form>
                                <!-- begin:: Mycart -->
                                <div class="kt-mycart">
                                    <div class="kt-mycart__head kt-head" style="background-image: url(./sevron/assets/media/misc/bg-1.jpg);">
                                    ...
                                    <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245" data-mobile-height="200">
                                        ...
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                <img src="./sevron/assets/media/products/product13.jpg" title="">
                                                </a>     
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                <img src="./sevron/assets/media/products/product16.jpg" title="">
                                                </a>    
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                <img src="./sevron/assets/media/products/product15.jpg" title="" alt="">
                                                </a>     
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="kt-grid-nav kt-grid-nav--skin-light">
                                    ...
                                    <div class="kt-grid-nav__row">
                                        ...
                                        <a href="#" class="kt-grid-nav__item">
                                            ...
                                            <span class="kt-grid-nav__title">ers</span>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,10px">
                            ...
                            <img alt="Pic" src="./sevron/assets/media/users/300_21.jpg"/>
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                            ...
                            <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
                                <div class="kt-user-card__avatar">
                                    <img class="kt-hidden-" alt="Pic" src="./sevron/assets/media/users/300_25.jpg" />
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                            <span class="kt-header__topbar-icon">
                            <img class="" src="./sevron/assets/media/flags/012-uk.svg" alt="" />
                            </span>
                        </div>
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    ...
                                    <span class="kt-nav__link-icon"><img src="./sevron/assets/media/flags/020-flag.svg" alt="" /></span>
                                    <span class="kt-nav__link-text">English</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                    <span class="kt-nav__link-icon"><img src="./sevron/assets/media/flags/016-spain.svg" alt="" /></span>
                                    <span class="kt-nav__link-text">Spanish</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                    <span class="kt-nav__link-icon"><img src="./sevron/assets/media/flags/017-germany.svg" alt="" /></span>
